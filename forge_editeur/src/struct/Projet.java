...
public class Projet implements Serializable{
	...
	public static final int PROJET_VERSION = 80;
	    private String Name;
	    //TODO @BETA Fonction ReinitPlayer()
	    //TODO @BETA Quand on renomme une carte, proposer les modifications automatique de Teleport
	    //TODO @BETA Fonction SerializeStat du joueur du style Variable[machin]=SerializeStat()
	    //TODO @BETA Fonction ChargeStat(VariableMachin)
	    // Dans le menu un élément "Héros" qui permet de choisir / charger le héros de son choix
	    //TODO @BETA Fonction Video('')
	    //TODO @BETA Fonction Utilise('')
	    //TODO @BETA Fonction Desequipe('')
	    //TODO @BETA/JAMAIS Déplacement diagonal
	    //TODO @BETA Fonction Sprite, MoveSprite, AnimateSprite
		...
		public class Carte implements Serializable
		{
		    ...
		    public void resizeEvenement(int W,int H)
		    {
		    	...
		    	{
		    		if (event[i]!=null)
		    		  event[i]=(Evenements[]) resizeArray(event[i],H);
		    		else
		    		  event[i]=new Evenements[H];
		    	}
		    ...
		    {
		    	Case[][] tab=this.cases;
		    	int oldw=this.cases.length; int oldh=this.cases[0].length;
		    	tab=(Case[][]) resizeArray(tab, W);
		    	for(int i=0;i<W;i++)
		    	{
		    		if (tab[i]!=null)
		    		  tab[i]=(Case[]) resizeArray(tab[i],H);
		    		else
		    		  tab[i]=new Case[H];
		    	}
		    	for (int i=oldw;i<W;i++)
		    		for(int j=0;j<oldh;j++)
		    			tab[i][j]=new Case();
		    	for (int i=0;i<W;i++)
		    		for(int j=oldh;j<H;j++)
		    			tab[i][j]=new Case();
		    	this.cases=tab;
		    }
		}
		public class Zone implements Serializable
		{
		    ...
		    public Zone()
		    {
		    	X1=0; X2=0; Y1=0; Y2=0; MonstreMax=0;
		    	ZoneTypeMonstre=0; VitesseSpawn=0;
		    }
		    public Zone clone()
		    {
		    	Zone z=new Zone();
		...
		public class Case implements Serializable
		{
			...
			public Case() { X1=0; Y1=0; X2=0; Y2=0; }
		}
		public class Evenements implements Serializable
		{
			...
			public Evenements clone()
	    	{
	    		...
	    		for (i=0;i<evenement.size();i++)
	    		{
	    			...
	    			if(CondDecl.size()<=i) ev.CondDecl.get(i).add("");
	    			else
	    			...
	    			if(CommandeEv.size()<=i) ev.CommandeEv.get(i).add("");
	    			else
		...
		public class Evenement implements Serializable
		{
	        ...
	        {
	        	Visible=true;
	        	X=0; Y=0; W=24; H=32; Z=0; Direction=2;
	        	Vitesse=1;
	        	NumAnim=1;
	        	Name="";
	        	Chipset="";
	        ...
	        public Evenement clone()
	        {
		        ...
		        ev.X=this.X; ev.Y=this.Y;
		        ev.Visible=this.Visible; ev.Bloquant=this.Bloquant;
		        ev.Transparent=this.Transparent;
		        ev.EvSuisSprite=this.EvSuisSprite;
		        ev.TypeAnim=this.TypeAnim; ev.Direction=this.Direction; ev.Vitesse=this.Vitesse;
		        ev.W=this.W; ev.H=this.H; ev.Z=this.Z; ev.NumAnim=this.NumAnim;	        	
	        	return ev;
	        }
		}
		public class Monstre implements Serializable
		{
		    ...
		    public Monstre(String NomMonstre)
		    {
		    	...
		    	W=24; H=32;
		    	Vitesse=1;
		    	Attaque=0; Defense=0; Dommage=0;
		    	Vie=0; XPMin=0; XPMax=0; GoldMin=0; GoldMax=0;
		...
		public class Magie implements Serializable
		{
		    ...
		    public Magie(String NomMagie)
		    {
		    	...
		    	W=24; H=32; Tran=255;
		    	Z=0; DureeAnim=42;
		    	Classe=0; MagieType=0;
		    	MPNeeded=0; LvlMin=0;
		    	OnMonster=0; TempsIncantation=60;
		    }
		}
		...
		public ArrayList<ClasseJoueur> getClassesJoueur() { return classesjoueur; }
		public ArrayList<ClasseMonstre> getClassesMonstre() { return classesmonstre; }
		public ArrayList<Carte> getCartes() { return cartes; }
		public ArrayList<Integer> getCourbeXP() { return CourbeXP; }
		public void setCartes(ArrayList<Carte> c) { cartes=c; }
		...
		public Monstre getMonstreByIndex(int index) { return monstres.get(index); }
		public ArrayList<Objet> getObjets() { return objets; }
		public Objet getObjetByIndex(int index) { return objets.get(index); }
		...
		public ArrayList<Magie> getMagies() { return magies; }
		public Magie getMagieByIndex(int index) { return magies.get(index); }
		...
		public ArrayList<Block> getBlocages() { return Blocage; }
		...
		public Block resizeBlocage(Block b,int W,int H)
		{
	    	...
	    	for(int j=0;j<2;j++)
	    	{
		    	...
		    	{
		    		if (tab[j][i]!=null)
		    		  tab[j][i]=(boolean[]) resizeArray(tab[j][i],H);
		    		else
		    		  tab[j][i]=new boolean[H];
		    	}
	    	}
	    	b.blocage=tab;
	    	return b;			
		...
		public void setDepart(Depart dep) { depart=dep; }
		public Depart getMort() { return mort; }
		public void setMort(Depart mrt) { mort=mrt; }
		public short getStyleProjet() { return style_projet; }
		public void setStyleProjet(short sp) { style_projet=sp; }
		public short getTileWidth() { return TileWidth; }
		public void setTileWidth(short tw) { TileWidth=tw; }
		public short getTileHeight() { return TileHeight; }
		public void setTileHeight(short th) { TileHeight=th; }
		public void setMenuFreeze(boolean mf) { MenuFreeze=mf; }
		public boolean isMenuFreeze() { return MenuFreeze; }
	}